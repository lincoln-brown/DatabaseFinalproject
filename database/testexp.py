...
for i in range(100000,600000):
	...
	Username.append(fake.bothify(text='User????')+str(i))
	
print(len(UserId),len(ProfileId),len(Username))
#random.shuffle(UserId)
#random.shuffle(ProfileId)


#populating populating Users 
with open('Users.csv','w',newline='') as f:
     thewriter = csv.writer(f)
     thewriter.writerow(['UserId','FirstName','LastName','Gender','DOB'])
     for i in range(0,macs):
     	thewriter.writerow([UserId[i],fake.first_name(),fake.last_name(),fake.random.choice(FGender),fake.date_of_birth()])
...
with open('profile_email.csv','w',newline='') as f:
     ...
     for i in range (0,macs):
     	thewriter.writerow([ProfileId[i],fake.email()])
...
with open('profile_phonenumber.csv','w',newline='') as f:
     ...
     for i in range (0,macs):
     	thewriter.writerow([ProfileId[i],fake.bothify(text='###-###-####')])
...
with open('profile_address.csv','w',newline='') as f:
     ...
     for i in range (0,macs):
     	thewriter.writerow([ProfileId[i],'ADID'+str(i),fake.street_name(),fake.city()])
'''
